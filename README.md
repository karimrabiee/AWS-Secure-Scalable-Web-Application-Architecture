...
AWS WAF uses AWS Managed Rules to help block common web exploits and known-bad traffic — this is threat mitigation, not a guarantee. Full detail: [`docs/SECURITY.md`](docs/SECURITY.md)
...
| [`docs/SECURITY.md`](docs/SECURITY.md) | Security design reference |
